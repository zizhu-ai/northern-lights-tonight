...
days. One late lease takeover per cycle would conservatively double that to
172,800, still below the 1M plan allowance.

Monitor Vercel Blob operations separately. Re-check the vendor's definition
of a billable unit at checkout before relying on this allowance.
